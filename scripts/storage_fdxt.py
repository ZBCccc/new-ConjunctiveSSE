...
def calculate_storage(json_file_path):
    ...
    try:
        ...
        # 计算总空间占用
        csv_file_path = json_file_path.replace('.json', '_storage_fdxt_1.csv')
        with open(csv_file_path, 'w', encoding='utf-8') as csv_file:
            ...
            for i, (keyword, file_count) in enumerate(data.items()):
                ...
                storage = (i + 1) * calculate_binary_storage(file_count) * 2
...
if __name__ == "__main__":
    ...
    print(calculate_binary_storage(1), calculate_binary_storage(2))
