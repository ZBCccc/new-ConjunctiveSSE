...
def main():
    ...
    max_wiki = 9738
    storage1 = 0
    Crime_file_path = 'scripts/search-tokens/data/w2_fdxt_crime_storage_data.csv'
    Enron_file_path = 'scripts/search-tokens/data/w2_fdxt_enron_storage_data.csv'
    Wiki_file_path = 'scripts/search-tokens/data/w2_fdxt_wiki_storage_data.csv'
