...
def main():
    ...
    storage2 = updtw1 * 32
    storage3 = updtw1 * 18
    Crime_file_path = 'scripts/search-tokens/data/w1_odxt_crime_storage_data.csv'
    Enron_file_path = 'scripts/search-tokens/data/w1_odxt_enron_storage_data.csv'
    Wiki_file_path = 'scripts/search-tokens/data/w1_odxt_wiki_storage_data.csv'
