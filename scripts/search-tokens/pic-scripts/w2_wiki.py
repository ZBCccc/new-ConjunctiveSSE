...
file_paths = {
    "FDXT": "scripts/search-tokens/data/w2_fdxt_wiki_storage_data.csv",
    "ODXT": "scripts/search-tokens/data/w2_odxt_wiki_storage_data.csv",
    "SDSSE-CQ": "scripts/search-tokens/data/w2_sdssecq_wiki_storage_data.csv"
}
...
ax_main.set_yticks([200, 400, 600, 800, 1000])
ax_main.set_yticklabels(['200', '400', '600', '800', '1000'], fontsize=50)
...
# 保存文件
plt.savefig("scripts/search-tokens/pic/Wiki_w2_comm_cost_comparison.pdf", dpi=3600, format='pdf')
