...
file_paths = {
    "FDXT": "scripts/search-tokens/data/w1_fdxt_enron_storage_data.csv",
    "ODXT": "scripts/search-tokens/data/w1_odxt_enron_storage_data.csv",
    "SDSSE-CQ": "scripts/search-tokens/data/w1_sdssecq_enron_storage_data.csv"
}
...
# 创建带有断点的y轴
ax_main.set_ylim(0, 900)
ax_main.set_yticks([150, 300, 450, 600, 750, 900])
ax_main.set_yticklabels(['150', '300', '450', '600', '750', '900'], fontsize=50)
...
ax_main.yaxis.set_minor_locator(plt.MultipleLocator(75))  # 调整次要刻度间隔
...
# 保存文件
plt.savefig("scripts/search-tokens/pic/Enron_w1_comm_cost_comparison.pdf", dpi=3600, format='pdf')
