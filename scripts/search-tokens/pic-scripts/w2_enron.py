...
file_paths = {
    "FDXT": "scripts/search-tokens/data/w2_fdxt_enron_storage_data.csv",
    "ODXT": "scripts/search-tokens/data/w2_odxt_enron_storage_data.csv",
    "SDSSE-CQ": "scripts/search-tokens/data/w2_sdssecq_enron_storage_data.csv"
}
...
# 创建带有断点的y轴
ax_main.set_ylim(0, 2500)
ax_main.set_yticks([500, 1000, 1500, 2000, 2500])
ax_main.set_yticklabels(['500', '1000', '1500', '2000', '2500'], fontsize=50)
...
ax_main.yaxis.set_minor_locator(plt.MultipleLocator(250))  # 调整次要刻度间隔
...
# 保存文件
plt.savefig("scripts/search-tokens/pic/Enron_w2_comm_cost_comparison.pdf", dpi=3600, format='pdf')
