...
file_paths = {
    "FDXT": "scripts/search-tokens/data/w1_fdxt_wiki_storage_data.csv",
    "ODXT": "scripts/search-tokens/data/w1_odxt_wiki_storage_data.csv",
    "SDSSE-CQ": "scripts/search-tokens/data/w1_sdssecq_wiki_storage_data.csv"
}
...
ax_main.set_yticks([100, 200, 300, 400])
ax_main.set_yticklabels(['100', '200', '300', '400'], fontsize=50)
...
# 保存文件
plt.savefig("scripts/search-tokens/pic/Wiki_w1_comm_cost_comparison.pdf", dpi=3600, format='pdf')
