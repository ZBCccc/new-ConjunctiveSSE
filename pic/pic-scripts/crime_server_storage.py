...
# 预设文件地址
file_paths = {
    "FDXT": "pic/data/FDXT_Crime.csv",
    "ODXT": "pic/data/ODXT_Crime.csv",
    "SDSSE-CQ": "pic/data/SDSSE-CQ_Crime.csv",
    "Mitra": "pic/data/Mitra_Crime.csv",
    "Bestie": "pic/data/Bestie_Crime.csv"
}
...
y_labels = ['$10^{-2}$', '$10^{-1}$', '$10^{0}$', '$10^{1}$', '$10^{2}$', '$10^{3}$']
...
# 保存文件
plt.savefig("pic/storage/Crime_storage_comparison.pdf", dpi=3600, format='pdf')
