...
# 预设文件地址
file_paths = {
    "FDXT": "pic/client_data/FDXT_Enron.csv",
    "ODXT": "pic/client_data/ODXT_Enron.csv",
    "SDSSE-CQ": "pic/client_data/SDSSE-CQ_Enron.csv"
}
...
# 保存文件
plt.savefig("pic/client_storage/Enron_client_storage_comparison.pdf", dpi=3600, format='pdf')
