...
# 预设文件地址
file_paths = {
    "FDXT": "pic/data/FDXT_Enron.csv",
    "ODXT": "pic/data/ODXT_Enron.csv",
    "SDSSE-CQ": "pic/data/SDSSE-CQ_Enron.csv",
    "Mitra": "pic/data/Mitra_Enron.csv",
    "Bestie": "pic/data/Bestie_Enron.csv"
}
...
# 保存文件
plt.savefig("pic/storage/Enron_storage_comparison.pdf", dpi=3600, format='pdf')
