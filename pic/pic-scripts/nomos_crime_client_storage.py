...
# 预设文件地址
file_paths = {
    "Nomos": "pic/nomos_client_data/Nomos_Crime.csv",
    "MC-ODXT": "pic/nomos_client_data/MC-ODXT_Crime.csv",
    "VQNomos": "pic/nomos_client_data/VQNomos_Crime.csv"
}
...
ax_main.yaxis.set_minor_locator(FixedLocator([87.5, 262.5, 437.5, 612.5]))
...
# 保存文件
plt.savefig("pic/nomos_client_storage/Crime_client_storage_comparison.pdf", dpi=3600, format='pdf')
