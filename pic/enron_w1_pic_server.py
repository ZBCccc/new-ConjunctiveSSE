...
# 预设文件地址（实际使用时替换）
file_paths = {
    "FDXT": "result/Search/FDXT/Enron_USENIX/2025-03-30_13-41-01w2_keywords_2.csv",
...
# 保存文件
plt.savefig("pic/w1-server/Enron_server_computation_time_comparison.pdf", dpi=3600, format='pdf')
