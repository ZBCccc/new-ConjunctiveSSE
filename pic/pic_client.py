...
# 预设文件地址（实际使用时替换）
file_paths = {
    "FDXT": "result/Search/FDXT/Wiki_USENIX/w1_keywords_2.csv",
...
# 创建带有断点的y轴
ax_main.set_ylim(0, 0.2)
ax_main.set_yticks([0.05,0.1, 0.15, 0.2])
ax_main.set_yticklabels(['0.05', '0.1', '0.15', '0.2'], fontsize=36)
...
# 保存文件
plt.savefig("pic/w1-server/Wiki_client_computation_time_comparison.pdf", dpi=3600, bbox_inches='tight', format='pdf')
plt.savefig("pic/w1-server/Wiki_client_computation_time_comparison.svg", dpi=3600, bbox_inches='tight', format='svg')
plt.savefig("pic/w1-server/Wiki_client_computation_time_comparison.png", dpi=3600, bbox_inches='tight', format='png')
