...
# 保存文件
plt.savefig("pic/w2-server/Crime_server_computation_time_comparison.pdf", dpi=3600, format='pdf')
# plt.savefig("pic/w2-server/Crime_server_computation_time_comparison.svg", dpi=3600, bbox_inches='tight', format='svg')
# plt.savefig("pic/w2-server/Crime_server_computation_time_comparison.png", dpi=3600, bbox_inches='tight', format='png')
